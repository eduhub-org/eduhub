...
export const SchoolClassEditor: FC<IProps> = ({
    ...
    name, onChangeName,
    grade,
    studentsCount, onChangeStudentsCount,
    ...
    const handleSelectName = useCallback((event) => {
    ...
    const handleSelectStudentsCount = useCallback(event => {
    ...
    return <>
        ...
        <div className={className || ""}>
            <div className="flex gap-3 mb-3">
                ...
                <input className="border border-black" type="text" value={name || ""} disabled={renderDisabled} onChange={handleSelectName} />
                <span>Klassenstufe {grade || 1}</span>
                <span>Klassengröße</span>
                <input className="border border-black" type="number" min={0} max={100} value={studentsCount || 25} onChange={handleSelectStudentsCount}/>
            </div>
        </div>
