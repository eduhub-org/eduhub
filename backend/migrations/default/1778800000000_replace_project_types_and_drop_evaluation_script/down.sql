...
SET "type" = NULL
WHERE "type" IN ('CLASSIC_PROJECT', 'PROJECT_WITH_LINK', 'PROJECT_WITH_PRESENTATION', 'PROJECT_WITH_LINK_AND_PRESENTATION');

UPDATE "public"."Program"
SET "defaultProjectType" = NULL
WHERE "defaultProjectType" IN ('CLASSIC_PROJECT', 'PROJECT_WITH_LINK', 'PROJECT_WITH_PRESENTATION', 'PROJECT_WITH_LINK_AND_PRESENTATION');

DELETE FROM "public"."ProjectType"
WHERE "value" IN ('CLASSIC_PROJECT', 'PROJECT_WITH_LINK', 'PROJECT_WITH_PRESENTATION', 'PROJECT_WITH_LINK_AND_PRESENTATION');
