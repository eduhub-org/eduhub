-- pg_advisory_xact_lock accepts (bigint) or (int, int), not (bigint, bigint).
-- The project-leave triggers cast both args to bigint, which fails at runtime.
...
BEGIN
  ...
  PERFORM pg_advisory_xact_lock(
    hashtext('public.ProjectAuthor.projectId'),
    OLD."projectId"
  );
