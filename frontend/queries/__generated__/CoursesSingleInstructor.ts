...
// ====================================================
// GraphQL query operation: CoursesSingleInstructor
// ====================================================

export interface CoursesSingleInstructor_Course_Sessions {
  __typename: "Session";
  id: number;
  /**
...
export interface CoursesSingleInstructor_Course_CourseInstructors_Expert_User {
  __typename: "User";
  /**
...
export interface CoursesSingleInstructor_Course_CourseInstructors_Expert {
  __typename: "Expert";
  id: number;
  /**
   * An object relationship
   */
  User: CoursesSingleInstructor_Course_CourseInstructors_Expert_User;
  /**
...
export interface CoursesSingleInstructor_Course_CourseInstructors {
  __typename: "CourseInstructor";
  id: number;
  /**
   * An object relationship
   */
  Expert: CoursesSingleInstructor_Course_CourseInstructors_Expert;
}

export interface CoursesSingleInstructor_Course {
  __typename: "Course";
  id: number;
  /**
   ...
   */
  Sessions: CoursesSingleInstructor_Course_Sessions[];
  /**
   * An array relationship
   */
  CourseInstructors: CoursesSingleInstructor_Course_CourseInstructors[];
}

export interface CoursesSingleInstructor {
  /**
   * fetch data from the table: "Course"
   */
  Course: CoursesSingleInstructor_Course[];
}

export interface CoursesSingleInstructorVariables {
  expertId: number;
}
