...
//       }
//     }
//     EnrollmentCount: CourseEnrollments_aggregate {
//       aggregate {
//         count
//       }
// 	   }
//     AppliedCount: CourseEnrollments_aggregate(where:
//       {
//         CourseEnrollmentStatus: {value: {_eq: "APPLIED"}}
//       }
//     ) {
...
//       }
//     }
//     InvitedCount: CourseEnrollments_aggregate(where:
//       {
//         CourseEnrollmentStatus: {value: {_eq: "INVITED"}}
//       }
//     ) {
//       aggregate{
//         count
//       }
//     }
//     ConfirmedCount: CourseEnrollments_aggregate(where:
//       {
//         CourseEnrollmentStatus: {value: {_eq: "CONFIRMED"}}
//       }
//     ) {
//       aggregate{
//         count
//       }
//     }
//     AppliedAndUnratedCount: CourseEnrollments_aggregate(where:
//       {
//         _and: [
//           {CourseEnrollmentStatus: {value: {_eq: "APPLIED"}}},
//           {MotivationRating: {value: {_eq: "UNRATED"}}}
