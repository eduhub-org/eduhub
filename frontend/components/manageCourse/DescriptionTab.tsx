...
import { eventTargetValueMapper, identityEventMapper, pickIdPkMapper, useDeleteCallback, useUpdateCallback, useUpdateCallback2 } from "../../hooks/authedMutation";
import { useInstructorQuery } from "../../hooks/authedQuery";
import { DELETE_COURSE_LOCATION, INSERT_NEW_COURSE_LOCATION, LOCATION_OPTIONS, UPDATE_COURSE_CONTENT_DESCRIPTION_FIELD_1, UPDATE_COURSE_CONTENT_DESCRIPTION_FIELD_2, UPDATE_COURSE_END_TIME, UPDATE_COURSE_HEADING_DESCRIPTION_1, UPDATE_COURSE_HEADING_DESCRIPTION_2, UPDATE_COURSE_LANGUAGE, UPDATE_COURSE_LEARNING_GOALS, UPDATE_COURSE_LOCATION_LINK, UPDATE_COURSE_LOCATION_OPTION, UPDATE_COURSE_START_TIME, UPDATE_COURSE_WEEKDAY } from "../../queries/course";
import { DeleteCourseLocation, DeleteCourseLocationVariables } from "../../queries/__generated__/DeleteCourseLocation";
import { InsertCourseLocation, InsertCourseLocationVariables } from "../../queries/__generated__/InsertCourseLocation";
import { LocationOptionsKnown } from "../../queries/__generated__/LocationOptionsKnown";
import { ManagedCourse_Course_by_pk } from "../../queries/__generated__/ManagedCourse";
import { UpdateCourseContentDescriptionField1, UpdateCourseContentDescriptionField1Variables } from "../../queries/__generated__/UpdateCourseContentDescriptionField1";
import { UpdateCourseContentDescriptionField2, UpdateCourseContentDescriptionField2Variables } from "../../queries/__generated__/UpdateCourseContentDescriptionField2";
import { UpdateCourseEndTime, UpdateCourseEndTimeVariables } from "../../queries/__generated__/UpdateCourseEndTime";
import { UpdateCourseHeadingDescription1, UpdateCourseHeadingDescription1Variables } from "../../queries/__generated__/UpdateCourseHeadingDescription1";
import { UpdateCourseHeadingDescription2, UpdateCourseHeadingDescription2Variables } from "../../queries/__generated__/UpdateCourseHeadingDescription2";
import { UpdateCourseLanguage, UpdateCourseLanguageVariables } from "../../queries/__generated__/UpdateCourseLanguage";
import { UpdateCourseLearningGoals, UpdateCourseLearningGoalsVariables } from "../../queries/__generated__/UpdateCourseLearningGoals";
import { UpdateCourseLocationLink, UpdateCourseLocationLinkVariables } from "../../queries/__generated__/UpdateCourseLocationLink";
import { UpdateCourseLocationOption, UpdateCourseLocationOptionVariables } from "../../queries/__generated__/UpdateCourseLocationOption";
import { UpdateCourseStartTime, UpdateCourseStartTimeVariables } from "../../queries/__generated__/UpdateCourseStartTime";
import { UpdateCourseWeekday, UpdateCourseWeekdayVariables } from "../../queries/__generated__/UpdateCourseWeekday";
import EhTimeSelect, { extractLocalTimeFromTimeTz } from "../common/EhTimeSelect";
...
export const DescriptionTab: FC<IProps> = ({
    course,
    qResult
}) => {
        ...
        <div>
            ...
            <div className="grid grid-cols-2">
                <div className="mr-3 ml-3">
                    Titel Info Block 1 (max. 50 Zeichen)
                </div>
                <div className="mr-3 ml-3">
                    Titel Info Block 2 (max. 50 Zeichen)
                </div>
            </div>
            <div className="grid grid-cols-2 mb-8">
                <DebounceInput
            ...
            <div className="grid grid-cols-2">
                <div className="mr-3 ml-3">
                    Text Info Block 1 (max. 1500 Zeichen)
                </div>
                <div className="mr-3 ml-3">
                    Text Info Block 2 (max. 1500 Zeichen)
                </div>
            </div>
            <div className="grid grid-cols-2 mb-8">
                <DebounceInput
