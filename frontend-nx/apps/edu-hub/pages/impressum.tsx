    ...
    <>
      ...
      <Page className="text-white">
        ...
        <div className="ml-24 mr-10">
          ...
          <p>
            Die Datenverarbeitung auf dieser Website erfolgt durch den Campus
            Business Box e.V., Fraunhoferstr. 13, 24118 Kiel.
          </p>{' '}
          <p>
          ...
          <p>
            Der Websitebetreiber speichert Profildaten (Namen, Email sowie ggf.
            Studentenstatus und Uni) aller Kursteilnehmenden, um die
            Kursdurchführung und die Erstellung der Zertifikate automatisiert zu
            unterstützen (Art. 6 Abs. 1 lit. f DSGVO).
          </p>
          <h3 className="text-lg mt-2 mb-2 italic">
            Informationen zur Kursteilnahme
          </h3>{' '}
          <p>
            Der Websitebetreiber speichert Daten zu Kursen, für die sich
            registrierte Nutzer:innen beworben haben bzw. an denen sie
            teilgenommen haben sowie zugehörige Informationen über die Erfüllung
            der angesetzten Leistungskriterien für die Kurse, die zur
            Ausstellung der Zertifikate benötigt werden (Art. 6 Abs. 1 lit. f
            DSGVO).
          </p>
          <h3 className="text-lg mt-2 mb-2 italic">
            Fragebogendaten zur Evaluation und Weiterentwicklung des
            Kursprogramms
          </h3>{' '}
          <p>
            Der Websitebetreiber versendet regelmäßig Fragebögen zur Evaluation
            von Kursangeboten, an denen Nutzer:innen teilnehmen und kann
            zusätzlich Fragebögen versenden, die zur generellen
            Weiterentwicklung des Kursangebots und der Plattform dienen. Die
            zugehörigen Antwortdaten werden durch den Websitebetreiber
            gespeichert und ausgewertet (Art. 6 Abs. 1 lit. f DSGVO).
          </p>
        </div>
      </Page>
    </>
