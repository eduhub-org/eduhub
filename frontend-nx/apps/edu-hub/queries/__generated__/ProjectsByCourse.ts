...
export interface ProjectsByCourse_Project_ProjectDocumentationInstruction {
...
export interface ProjectsByCourse_Project_ProjectAuthors_User_Organization {
  __typename: "Organization";
  id: number;
  name: string;
}
...
export interface ProjectsByCourse_Project_ProjectAuthors_User {
   ...
   */
  Organization: ProjectsByCourse_Project_ProjectAuthors_User_Organization | null;
}
...
export interface ProjectsByCourse_Project {
   ...
   * An object relationship
   */
  ProjectDocumentationInstruction: ProjectsByCourse_Project_ProjectDocumentationInstruction | null;
  /**
   * An object relationship
   */
   ...
   * An array relationship
   */
  ProjectConsentEvents: ProjectsByCourse_Project_ProjectConsentEvents[];
}
