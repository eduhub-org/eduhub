...
export interface MyProjectByCourse_Project_ProjectDocumentationTemplate {
...
export interface MyProjectByCourse_Project {
   ...
   * An object relationship
   */
  ProjectDocumentationTemplate: MyProjectByCourse_Project_ProjectDocumentationTemplate | null;
  /**
   * An object relationship
   */
