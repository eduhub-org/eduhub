...
// ====================================================
// GraphQL fragment: CourseFragmentAnonymous
// ====================================================

export interface CourseFragmentAnonymous_Sessions_SessionAddresses_CourseLocation {
...
export interface CourseFragmentAnonymous_Sessions_SessionAddresses {
   ...
   */
  CourseLocation: CourseFragmentAnonymous_Sessions_SessionAddresses_CourseLocation | null;
}

export interface CourseFragmentAnonymous_Sessions_SessionSpeakers_Expert_User {
  __typename: "User";
  id: any;
  /**
...
export interface CourseFragmentAnonymous_Sessions_SessionSpeakers_Expert {
  __typename: "Expert";
  /**
   * An object relationship
   */
  User: CourseFragmentAnonymous_Sessions_SessionSpeakers_Expert_User;
}

export interface CourseFragmentAnonymous_Sessions_SessionSpeakers {
  __typename: "SessionSpeaker";
  /**
   * An object relationship
   */
  Expert: CourseFragmentAnonymous_Sessions_SessionSpeakers_Expert;
}

export interface CourseFragmentAnonymous_Sessions {
  __typename: "Session";
  id: number;
  /**
   ...
   * An array relationship
   */
  SessionSpeakers: CourseFragmentAnonymous_Sessions_SessionSpeakers[];
}

export interface CourseFragmentAnonymous_CourseInstructors_Expert_User {
  __typename: "User";
  id: any;
  /**
   * The user's first name
...
export interface CourseFragmentAnonymous_CourseInstructors_Expert {
  __typename: "Expert";
  id: number;
  /**
   ...
   * An object relationship
   */
  User: CourseFragmentAnonymous_CourseInstructors_Expert_User;
}

export interface CourseFragmentAnonymous_CourseInstructors {
  __typename: "CourseInstructor";
  id: number;
  /**
   * An object relationship
   */
  Expert: CourseFragmentAnonymous_CourseInstructors_Expert;
}

export interface CourseFragmentAnonymous_CourseLocations {
  __typename: "CourseLocation";
  id: number;
  /**
   * Will be used as default for any new session address.
...
export interface CourseFragmentAnonymous_Program {
  __typename: "Program";
  id: number;
  /**
...
export interface CourseFragmentAnonymous_CourseGroups {
  __typename: "CourseGroup";
  id: number;
  /**
   * An object relationship
   */
  CourseGroupOption: CourseFragmentAnonymous_CourseGroups_CourseGroupOption;
}

export interface CourseFragmentAnonymous_DegreeCourses_Course_Program {
  __typename: "Program";
  id: number;
  /**
   * Decides whether the courses of this program can be published or not. (Courses are ony published if the filed publised in the Course table is also set to true.)
...
export interface CourseFragmentAnonymous_DegreeCourses_Course {
  __typename: "Course";
  id: number;
  /**
   ...
   * An object relationship
   */
  Program: CourseFragmentAnonymous_DegreeCourses_Course_Program;
}

export interface CourseFragmentAnonymous_DegreeCourses {
   ...
   * An object relationship
   */
  Course: CourseFragmentAnonymous_DegreeCourses_Course;
}

export interface CourseFragmentAnonymous_CourseFundingOrganizations_Organization {
...
export interface CourseFragmentAnonymous_CourseFundingOrganizations {
  __typename: "CourseFundingOrganization";
  id: number;
  /**
   * An object relationship
   */
  Organization: CourseFragmentAnonymous_CourseFundingOrganizations_Organization;
}

export interface CourseFragmentAnonymous {
  __typename: "Course";
  id: number;
  /**
   * The number of ECTS of the course (only editable by an admin user))
   ...
   * An array relationship
   */
  Sessions: CourseFragmentAnonymous_Sessions[];
  /**
   * An array relationship
   */
  CourseInstructors: CourseFragmentAnonymous_CourseInstructors[];
  /**
   * An array relationship
   */
  CourseLocations: CourseFragmentAnonymous_CourseLocations[];
  /**
   * An object relationship
   */
  Program: CourseFragmentAnonymous_Program;
  /**
   * An array relationship
   */
  CourseGroups: CourseFragmentAnonymous_CourseGroups[];
  /**
   * An array relationship
   */
  DegreeCourses: CourseFragmentAnonymous_DegreeCourses[];
  /**
   * An array relationship
   */
  CourseFundingOrganizations: CourseFragmentAnonymous_CourseFundingOrganizations[];
}
