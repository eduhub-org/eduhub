...
export interface MyEnrollmentsForCourseQuery_CourseEnrollment_Course_Sessions_SessionSpeakers_User {
  __typename: "User";
  id: any;
  /**
...
export interface MyEnrollmentsForCourseQuery_CourseEnrollment_Course_Sessions_SessionSpeakers {
   ...
   * An object relationship
   */
  User: MyEnrollmentsForCourseQuery_CourseEnrollment_Course_Sessions_SessionSpeakers_User;
}
...
export interface MyEnrollmentsForCourseQuery_CourseEnrollment_Course_CourseInstructors_User {
  __typename: "User";
  id: any;
  /**
   * The user's first name
...
export interface MyEnrollmentsForCourseQuery_CourseEnrollment_Course_CourseInstructors {
   ...
   * An object relationship
   */
  User: MyEnrollmentsForCourseQuery_CourseEnrollment_Course_CourseInstructors_User;
}
...
export interface MyEnrollmentsForCourseQuery_CourseEnrollment_Course_CourseFundingOrganizations_Organization {
...
export interface MyEnrollmentsForCourseQuery_CourseEnrollment_Course_CourseFundingOrganizations {
