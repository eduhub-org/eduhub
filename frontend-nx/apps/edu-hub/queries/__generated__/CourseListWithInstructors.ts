...
import { Weekday_enum, LocationOption_enum, SessionAddressType_enum, University_enum, CourseEnrollmentStatus_enum } from "./../../__generated__/globalTypes";

// ====================================================
// GraphQL query operation: CourseListWithInstructors
// ====================================================

export interface CourseListWithInstructors_Course_Sessions_SessionAddresses_CourseLocation {
...
export interface CourseListWithInstructors_Course_Sessions_SessionAddresses {
   ...
   */
  CourseLocation: CourseListWithInstructors_Course_Sessions_SessionAddresses_CourseLocation | null;
}

export interface CourseListWithInstructors_Course_Sessions_SessionSpeakers_Expert_User {
  __typename: "User";
  id: any;
  /**
...
export interface CourseListWithInstructors_Course_Sessions_SessionSpeakers_Expert {
  __typename: "Expert";
  /**
   * An object relationship
   */
  User: CourseListWithInstructors_Course_Sessions_SessionSpeakers_Expert_User;
}

export interface CourseListWithInstructors_Course_Sessions_SessionSpeakers {
  __typename: "SessionSpeaker";
  /**
   * An object relationship
   */
  Expert: CourseListWithInstructors_Course_Sessions_SessionSpeakers_Expert;
}

export interface CourseListWithInstructors_Course_Sessions {
  __typename: "Session";
  id: number;
  /**
   ...
   */
  SessionAddresses: CourseListWithInstructors_Course_Sessions_SessionAddresses[];
  /**
   * An array relationship
   */
  SessionSpeakers: CourseListWithInstructors_Course_Sessions_SessionSpeakers[];
}

export interface CourseListWithInstructors_Course_CourseInstructors_Expert_User {
  __typename: "User";
  /**
   * The user's first name
   */
...
export interface CourseListWithInstructors_Course_CourseInstructors_Expert {
  __typename: "Expert";
  id: number;
  /**
   * An object relationship
   */
  User: CourseListWithInstructors_Course_CourseInstructors_Expert_User;
  /**
...
export interface CourseListWithInstructors_Course_CourseInstructors {
  __typename: "CourseInstructor";
  id: number;
  /**
   * An object relationship
   */
  Expert: CourseListWithInstructors_Course_CourseInstructors_Expert;
}

export interface CourseListWithInstructors_Course_CourseLocations {
  __typename: "CourseLocation";
  id: number;
  /**
   * Will be used as default for any new session address.
...
export interface CourseListWithInstructors_Course_DegreeCourses_Course_Program {
  __typename: "Program";
  id: number;
  /**
   * Decides whether the courses of this program can be published or not. (Courses are ony published if the filed publised in the Course table is also set to true.)
...
export interface CourseListWithInstructors_Course_DegreeCourses_Course {
  __typename: "Course";
  id: number;
  /**
   ...
   * An object relationship
   */
  Program: CourseListWithInstructors_Course_DegreeCourses_Course_Program;
}

export interface CourseListWithInstructors_Course_DegreeCourses {
   ...
   * An object relationship
   */
  Course: CourseListWithInstructors_Course_DegreeCourses_Course;
}
...
export interface CourseListWithInstructors_Course {
  __typename: "Course";
  id: number;
  /**
   * The number of ECTS of the course (only editable by an admin user))
   ...
   * An array relationship
   */
  Sessions: CourseListWithInstructors_Course_Sessions[];
  /**
   * An array relationship
   */
  CourseInstructors: CourseListWithInstructors_Course_CourseInstructors[];
  /**
   * An array relationship
   */
  CourseLocations: CourseListWithInstructors_Course_CourseLocations[];
  /**
   * An object relationship
   */
  Program: CourseListWithInstructors_Course_Program;
  /**
   * An array relationship
   */
   ...
   * An array relationship
   */
  DegreeCourses: CourseListWithInstructors_Course_DegreeCourses[];
  /**
   * An array relationship
   */
  CourseEnrollments: CourseListWithInstructors_Course_CourseEnrollments[];
}

export interface CourseListWithInstructors {
  /**
   * fetch data from the table: "Course"
   */
  Course: CourseListWithInstructors_Course[];
}
