...
export interface CourseListWithEnrollments_Course_Sessions_SessionAddresses_CourseLocation {
...
export interface CourseListWithEnrollments_Course_Sessions_SessionAddresses {
   ...
   */
  CourseLocation: CourseListWithEnrollments_Course_Sessions_SessionAddresses_CourseLocation | null;
}

export interface CourseListWithEnrollments_Course_Sessions_SessionSpeakers_Expert_User {
  __typename: "User";
  id: any;
  /**
...
export interface CourseListWithEnrollments_Course_Sessions_SessionSpeakers_Expert {
  __typename: "Expert";
  /**
   * An object relationship
   */
  User: CourseListWithEnrollments_Course_Sessions_SessionSpeakers_Expert_User;
}

export interface CourseListWithEnrollments_Course_Sessions_SessionSpeakers {
  __typename: "SessionSpeaker";
  /**
   * An object relationship
   */
  Expert: CourseListWithEnrollments_Course_Sessions_SessionSpeakers_Expert;
}
...
export interface CourseListWithEnrollments_Course_Sessions {
   ...
   * An array relationship
   */
  SessionSpeakers: CourseListWithEnrollments_Course_Sessions_SessionSpeakers[];
}
