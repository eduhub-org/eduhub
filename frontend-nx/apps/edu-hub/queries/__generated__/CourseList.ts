...
export interface CourseList_Course_Sessions_SessionAddresses_CourseLocation {
...
export interface CourseList_Course_Sessions_SessionAddresses {
   ...
   */
  CourseLocation: CourseList_Course_Sessions_SessionAddresses_CourseLocation | null;
}

export interface CourseList_Course_Sessions_SessionSpeakers_User {
  __typename: "User";
  id: any;
  /**
...
export interface CourseList_Course_Sessions_SessionSpeakers {
  __typename: "SessionSpeaker";
  id: number;
  /**
   * An object relationship
   */
  User: CourseList_Course_Sessions_SessionSpeakers_User;
}
...
export interface CourseList_Course_Sessions {
   ...
   * An array relationship
   */
  SessionSpeakers: CourseList_Course_Sessions_SessionSpeakers[];
}

export interface CourseList_Course_CourseInstructors_User {
  __typename: "User";
  id: any;
  /**
   * The user's first name
...
export interface CourseList_Course_CourseInstructors {
   ...
   * An object relationship
   */
  User: CourseList_Course_CourseInstructors_User;
}
...
export interface CourseList_Course_DegreeCourses_Course_Program {
  __typename: "Program";
  id: number;
  /**
   * Decides whether the courses of this program can be published or not. (Courses are ony published if the filed publised in the Course table is also set to true.)
...
export interface CourseList_Course_DegreeCourses_Course {
  __typename: "Course";
  id: number;
  /**
   ...
   * An object relationship
   */
  Program: CourseList_Course_DegreeCourses_Course_Program;
}

export interface CourseList_Course_DegreeCourses {
...
export interface CourseList_Course_CourseAddonMappings {
...
export interface CourseList_Course {
   ...
   * An array relationship
   */
  CourseAddonMappings: CourseList_Course_CourseAddonMappings[];
}
