...
export interface Course_Course_by_pk_Program_Sessions_SessionAddresses_CourseLocation {
  __typename: "CourseLocation";
  id: number;
  /**
   * Either 'ONLINE' or one of the possible given offline locations
...
export interface Course_Course_by_pk_Program_Sessions_SessionAddresses {
  __typename: "SessionAddress";
  id: number;
  /**
   * Where the session will take place; might be an offline or online location which is provided according to the provided type
   ...
   * An object relationship
   */
  CourseLocation: Course_Course_by_pk_Program_Sessions_SessionAddresses_CourseLocation | null;
}

export interface Course_Course_by_pk_Program_Sessions_SessionSpeakers_User {
  __typename: "User";
  id: any;
  /**
   * The user's first name
...
export interface Course_Course_by_pk_Program_Sessions_SessionSpeakers {
  __typename: "SessionSpeaker";
  id: number;
  /**
   * An object relationship
   */
  User: Course_Course_by_pk_Program_Sessions_SessionSpeakers_User;
}

export interface Course_Course_by_pk_Program_Sessions {
  __typename: "Session";
  id: number;
  /**
   * The day and time of the end of the session
   ...
   * An array relationship
   */
  SessionAddresses: Course_Course_by_pk_Program_Sessions_SessionAddresses[];
  /**
   * An array relationship
   */
  SessionSpeakers: Course_Course_by_pk_Program_Sessions_SessionSpeakers[];
}
...
export interface Course_Course_by_pk_Program {
   ...
   * An array relationship
   */
  Sessions: Course_Course_by_pk_Program_Sessions[];
}
...
export interface Course_Course_by_pk_CourseFundingOrganizations_Organization {
...
export interface Course_Course_by_pk_CourseFundingOrganizations {
  __typename: "CourseFundingOrganization";
  id: number;
  /**
   * An object relationship
   */
  Organization: Course_Course_by_pk_CourseFundingOrganizations_Organization;
}

export interface Course_Course_by_pk_CourseAddonMappings {
...
export interface Course_Course_by_pk {
   ...
   * An array relationship
   */
  CourseFundingOrganizations: Course_Course_by_pk_CourseFundingOrganizations[];
  /**
   ...
   * An array relationship
   */
  CourseAddonMappings: Course_Course_by_pk_CourseAddonMappings[];
}
