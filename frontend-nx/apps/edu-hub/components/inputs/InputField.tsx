...
const InputField: React.FC<InputFieldProps> = ({
  ...
  min,
  max,
  immediateUpdate: _immediateUpdate, // Extract this prop to prevent it from being spread to DOM elements - eslint-disable-line @typescript-eslint/no-unused-vars
  ...props
}) => {
